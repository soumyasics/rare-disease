      ...
      <nav class="navbar navbar-expand-lg user_navbar ">
        <div class="container ">
          ...
          <div className="header-boxcontain d-flex">
            ...
            <Link
              to="/patient-viewcounsellorlist"
              style={{ textDecoration: "none" }}
            >
              <p className="nav-item">Councellors</p>
            </Link>
            <Link to="/patient-viewhcplist" style={{ textDecoration: "none" }}>
              {" "}
              <p className="nav-item">HCP</p>
            </Link>
            <Link to="/patient-viewblogs" style={{ textDecoration: "none" }}>
              {" "}
              <p className="nav-item">Blogs</p>
            </Link>
            <Link to="/patient-chatmian" style={{ textDecoration: "none" }}>
              {" "}
            ...
            >
              ...
              {openDropdown === "dropdown1" && (
                <div className="dropdown-content">
                  ...
                  <Link
                    to="/patient-viewcounsellorappoinment"
                    style={{ textDecoration: "none", color: "black" }}
                  >
                    <button
                      className="dropdown-item"
