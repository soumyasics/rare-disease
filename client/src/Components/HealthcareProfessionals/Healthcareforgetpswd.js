...
function Healthcareforgetpswd() {
    ...
    const handleSubmit = (e) => {
      ...
      axiosInstance.post(`forgotPwdhp`, { email, password, newPassword })
        .then((res) => {
          console.log(res);
  ...
  return (
    <div className="hplogin-container">
      ...
      <Link to="/health-login" style={{textDecoration:"none",color:"black"}}> <i className="ri-arrow-left-line arrow-icon" style={{marginRight:"400px",fontSize:"30px"}}></i></Link>
